"""LeadFlow B2B 영업 자동화 CLI 인터페이스 (Web 대시보드 포함).

사용법:
    leadflow scrape run --region 서울 --keyword 인력사무소
    leadflow leads list --status new
    leadflow email send-test --lead-id 123
    leadflow campaign run --name "2025-Q2"
    leadflow scheduler
    leadflow monitor
    leadflow web
"""
...
app = typer.Typer(
    name="leadflow",
    help="LeadFlow B2B 영업 자동화 파이프라인 CLI (Web 대시보드 포함)",
