...
from leadflow.db.models import Lead
...
from leadflow.email_sender.gmail_client import _get_gmail_service
...
def check_new_replies() -> None:
    ...
    with get_db() as db:
        ...
        if replies_found:
            try:
                from leadflow.crm.sheets_client import sync_data_to_sheets
