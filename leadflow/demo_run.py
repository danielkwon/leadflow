...
from leadflow.db.engine import init_db, get_db
from leadflow.db.repository import create_lead, get_leads, update_lead_email
...
from leadflow.utils.logging import setup_logging, get_logger
...
def run_demo():
    ...
    if not has_naver:
        ...
        with get_db() as db:
            for ml in mock_leads:
                from leadflow.db.repository import find_duplicate_lead
    ...
    with get_db() as db:
        from leadflow.db.repository import get_leads
